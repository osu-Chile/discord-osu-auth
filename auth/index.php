...
<body>
    <img src="https://osuchile.com/img/logo.svg"/>
    <div class="cont">
        <?php
...
?>
        ...
        <form action="https://osu.ppy.sh/oauth/authorize" method="GET" class="opl-login">
            ...
            <input type="hidden" name="client_id" value="4379">
            <input type="hidden" name="redirect_uri" value='https://osuchile.com/auth/auth.php'>
